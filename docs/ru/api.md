...
С версии 1.2.0 *шина* передаётся только в главный модуль плагина. Дальнейшее прохождение ссылки ложится на
...
С версии 1.2.0 изменился механизм инициализации модуля. Дальше в примерах кода приведён только новый вариант.  
...
С версии 1.2.0 изменилась сигнатура получения экземпляра, чтобы поддержать исправление независимости шины.  
